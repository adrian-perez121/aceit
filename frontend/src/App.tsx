...
function App() {
    const [welcomeMessage, setWelcomeMessage] = useState<InferResponseType<typeof client.api.$get>>()
    ...
    <>
        <div>Hello World!</div>
        <div className={"bg-blue-100 p-1.5 rounded-md text-black"}>Welcome Message From Backend: {welcomeMessage}</div>
    </>
    )
}
